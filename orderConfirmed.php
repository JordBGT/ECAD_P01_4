...
if(isset($_SESSION["OrderID"])) {	
    ...
    if ($_SESSION["ShipCharge"] == "5") {
        echo"Your items will be delivered within 2 working days after your order is placed!</p>";
    }
    else {
        echo"Your items will be delivered within 24 hours. Thank you for your purchase!</br>";
    }
