...
$PayPalApiUsername 	= 'sb-w5uct15257530_api1.business.example.com';//PayPal API Username
$PayPalApiPassword 	= 'R4KARXM7EVWUCDH3'; //Paypal API password
...
$PayPalCancelURL = 'http://localhost:8081/BaobeiComfort/fakeShoppingCart.php'; 
